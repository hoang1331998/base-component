...
import { clearUserInfo, getRefreshToken, getToken, setRefeshToken, setToken } from "../utils/storage";
...
export const postRequest = async (url = "", params, successCallback, errorCallback) => {
  return await axios
    .post(url, params)
    .then(response => {
      if (successCallback) {
...
export const putRequest = (url = "", params = {}, successCallback, errorCallback, headers = {}, timeout) => {
  return axios
    .put(url, params, {
      headers,
      timeout,
...
export const deleteRequest = (url = "", params = {}, successCallback, errorCallback, headers = {}, timeout) => {
  return axios
    .delete(url, params, {
      headers,
      timeout,
